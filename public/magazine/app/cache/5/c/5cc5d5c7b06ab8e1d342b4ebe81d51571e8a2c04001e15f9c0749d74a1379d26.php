...
class __TwigTemplate_5cc5d5c7b06ab8e1d342b4ebe81d51571e8a2c04001e15f9c0749d74a1379d26 extends Twig_Template
{
...
<ul>
    ...
    <li>
        ...
        if (twig_length_filter($this->env, $this->getAttribute((isset($context["request"]) ? $context["request"] : null), "routeParams", array()))) {
            // line 15
            echo "            ";
            $this->loadTemplate("@WebProfiler/Profiler/table.html.twig", "@WebProfiler/Router/panel.html.twig", 15)->display(array("data" => $this->getAttribute((isset($context["request"]) ? $context["request"] : null), "routeParams", array()), "class" => "inline"));
            // line 16
            echo "        ";
        } else {
            // line 17
